...
class DB_create:
    def db_create(self, queries_list, query_data):         # pylint: disable=too-many-return-statements,too-many-branches,inconsistent-return-statements,too-many-statements
